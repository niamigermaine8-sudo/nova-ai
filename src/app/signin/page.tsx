        ...
        <main className="mx-auto w-full max-w-xl rounded-[2rem] border border-white/10 bg-white/5 p-10 shadow-[0_30px_120px_-60px_rgba(0,0,0,0.6)] backdrop-blur-xl">
          <div className="mb-8 space-y-3 text-center">
            ...
            <p className="text-sm leading-6 text-zinc-300">
              Sign in to access your Nova assistant and continue where you left off.
            </p>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between text-sm text-zinc-300">
              ...
              <Link href="#" className="font-medium text-white/80 transition hover:text-white">
                Forgot password?
              </Link>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-zinc-300">
            New here?{' '}
            <Link href="/signup" className="font-semibold text-white transition hover:text-blue-300">
              Create an account
            </Link>
          </p>
        </main>
